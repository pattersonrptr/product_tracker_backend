...
@pytest.mark.asyncio
async def test_create_product_execute_propagates_errors(
    create_product_uc, mock_product_service
):
...
@pytest.mark.asyncio
async def test_get_product_by_id_execute_success(
    get_product_by_id_uc, mock_product_service
):
    product_id = 1
...
@pytest.mark.asyncio
async def test_filter_products_execute_success(
    filter_products_uc, mock_product_service
):
...
@pytest.mark.asyncio
async def test_search_products_execute_success(
    search_products_uc, mock_product_service
):
    query = "special"
...
@pytest.mark.asyncio
async def test_get_product_stats_execute_success(
    get_product_stats_uc, mock_product_service
):
...
@pytest.mark.asyncio
async def test_get_minimal_products_execute_success(
    get_minimal_products_uc, mock_product_service
):
    expected_result = [
