...
from product_scrapers.api.api_client import ApiClient
from product_scrapers.scrapers.factory.scraper_factory import ScraperFactory
from product_scrapers.scrapers.manager.scraper_manager import ScraperManager

broker_url = os.getenv("CELERY_BROKER_URL", "redis://redis:6379/0")
app = Celery(main="product_scrapers", broker=broker_url, backend="redis://redis:6379/0")


@app.task(name="product_scrapers.celery.tasks.run_scraper_searches")
...
@app.task(name="product_scrapers.celery.tasks.run_search")
...
@app.task(name="product_scrapers.celery.tasks.process_urls_list")
...
@app.task(name="product_scrapers.celery.tasks.scrape_product_page")
